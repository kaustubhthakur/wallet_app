...
ROOT_URLCONF = 'django_wallet.urls'
...
WSGI_APPLICATION = 'django_wallet.wsgi.application'

# MongoDB Database configuration
DATABASES = {
    'default': {
        'ENGINE': 'djongo',
        'NAME': config('MONGO_DB_NAME', default='django_wallet'),
        'CLIENT': {
